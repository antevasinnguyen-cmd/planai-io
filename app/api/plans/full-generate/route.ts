...
export async function POST(req: NextRequest) {
  try {
    ...
    const systemPrompt = [
      ...
      '  13. Mindmap lộ trình (BẮT BUỘC): Sử dụng mermaid mindmap với root = mục tiêu cuối, branches = milestone quý/năm, sub-branches = hành động cụ thể. Phải render đẹp và rõ ràng.',
      '  14. Kết luận + CTA nâng cấp: "Gói trả phí có bản kế hoạch chi tiết gấp 10 lần với 3 checklist riêng (tuần/tháng/năm), phân tích tử vi, 40+ tài liệu, v.v.".',
      '',
      'Lưu ý QUAN TRỌNG:',
