...
export async function POST(req: NextRequest) {
  try {
    ...
    const constraints = {
      ...
      max_tables: tier === 'free' ? 6 : tier === 'basic' ? 8 : tier === 'pro' ? 10 : 12,
    ...
    const systemPrompt = [
      ...
      '- Nếu tier là FREE: 2.200 từ, WOW content để user nâng cấp. BỐ CỤC 13 MỤC BẮT BUỘC (KHÔNG THIẾU, KHÔNG THỪA, KHÔNG "..."):',
      ...
      '      a) Checklist Tuần (Tuần 1-12): | Tuần | Hành động cụ thể | Mục tiêu | Link học | - ĐẦY ĐỦ dữ liệu.',
      '      b) Checklist Tháng (Tháng 1-12): | Tháng | Hành động cụ thể | Mục tiêu | Link học | - ĐẦY ĐỦ dữ liệu.',
      '      c) Kế hoạch tiết kiệm: | Tháng | Số tiền tiết kiệm | Đơn vị (tháng) | Nguồn tiền | Công cụ | - ĐẦY ĐỦ dữ liệu, tính toán chính xác.',
      '  11. Kế hoạch đầu tư (bảng): | Hạng mục đầu tư | Số tiền/tháng | Mục đích | Rủi ro | Kỳ vọng lợi nhuận | - VD: Đầu tư kiến thức (x VNĐ/tháng), Quỹ trái phiếu (x VNĐ/tháng), Kinh doanh (x VNĐ/tháng).',
      '  12. Tài liệu học tập (ít nhất 11 tài liệu): | Tên tài liệu | Loại | Link | Ngôn ngữ | Mô tả chi tiết kiến thức & lợi ích | - Ưu tiên Coursera, Khan Academy, edX, Roadmap.sh, YouTube, LinkedIn Learning, Skillshare, Google Books, TED, HubSpot, Ahrefs. Link phải dẫn trực tiếp tới khoá học/video, không dùng link tìm kiếm chung.',
      '  13. Kết luận + CTA nâng cấp: "Gói trả phí có bản kế hoạch chi tiết gấp 10 lần với 3 checklist riêng (tuần/tháng/năm), phân tích tử vi, 40+ tài liệu, v.v.".',
      '',
      'Lưu ý QUAN TRỌNG:',
