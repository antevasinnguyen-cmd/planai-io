...
export async function POST(req: NextRequest) {
  try {
    ...
    const systemPrompt = [
      ...
      '- Nếu tier là FREE: 2.200 từ, WOW content để user nâng cấp. BỐ CỤC 11 MỤC BẮT BUỘC (KHÔNG THIẾU, KHÔNG THỪA, KHÔNG "..."):',
      '  1. Tiêu đề: "KẾ HOẠCH TÀI CHÍNH CÁ NHÂN HOÁ MIỄN PHÍ - {mục tiêu cụ thể} trong {timeline} - Dành cho {tên user}".',
      '  2. Tóm tắt thông tin (bullet list): • Họ tên: {name} • Tuổi: {age} • Nơi ở: {location} • Thu nhập: {income} • Tiết kiệm: {savings} • Nghề: {job} • Kỹ năng: {skills} • Mục tiêu: {goal} • Timeline: {timeline} • Sẵn sàng: {readiness}/10.',
      '  3. Phân tích SWOT (bảng 4 cột ĐẦY ĐỦ dữ liệu VN 11/2025): | Điểm mạnh | Điểm yếu | Cơ hội | Thách thức | - KHÔNG "---", KHÔNG "...".',
      '  4. Phân tích mục tiêu tài chính (500 từ): tính toán chi tiết, gap analysis, ROI cụ thể.',
      '  5. Phân tích yếu tố khách quan & chủ quan (400 từ): kinh tế VN, ngành, cạnh tranh, tâm lý.',
      '  6. Phân tích kỹ năng cần có (300 từ): liệt kê chi tiết, ưu tiên, thời gian học.',
      '  7. Mindmap lộ trình tổng quan (mermaid mindmap - BẮT BUỘC): root là mục tiêu cuối, branches là milestone năm/quý.',
      '  8. Lộ trình theo timeline user (Ngày-Tuần-Tháng-Năm): văn bản chi tiết + link Google Sheet template.',
      '  9. Đề xuất hành động (200 từ): 3-5 hành động cụ thể, khả thi trong 24h.',
      '  10. Checklist hành động (bảng Markdown: Thời gian | Hành động cụ thể | Link tài liệu tham khảo): ĐẦY ĐỦ dữ liệu, KHÔNG "...".',
      '  11. Kết luận + CTA nâng cấp: "Gói trả phí có bản kế hoạch chi tiết gấp 10 lần với 3 checklist riêng (tuần/tháng/năm), phân tích tử vi, 40+ tài liệu, v.v.".',
      '',
      'Lưu ý QUAN TRỌNG:',
