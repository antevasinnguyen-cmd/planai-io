      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-6 space-y-3">
          <button
            ...
            className="w-full flex justify-center items-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-gray-700 hover:bg-gray-50 font-medium"
          >
