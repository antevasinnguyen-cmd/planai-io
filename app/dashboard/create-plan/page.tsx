...
const requiredInfo = [
  ...
  { id: 'full_name', label: 'Họ tên', icon: '👤', required: false, description: 'Họ tên đầy đủ (dùng cho phân tích tử vi)' },
  { id: 'gender', label: 'Giới tính', icon: '⚧️', required: false, description: 'Nam/Nữ (dùng cho phân tích tử vi)' },
  { id: 'birth_date', label: 'Ngày tháng năm sinh', icon: '🎂', required: false, description: 'Ngày/tháng/năm sinh (dùng cho phân tích tử vi)' },
  { id: 'birth_time', label: 'Giờ sinh', icon: '🕐', required: false, description: 'Giờ sinh (dùng cho lá số tử vi)' },
